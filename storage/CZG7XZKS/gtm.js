...
Z.b.vis=["google"],function(){var a={};(function(b){Z.__vis=b;Z.__vis.g="vis";Z.__vis.h=!0;Z.__vis.priorityOverride=0})(function(b){var c,d=[];d.push("CSS"===b.vtp_selectorType?b.vtp_elementSelector:"#"+b.vtp_elementId);d.push(b.vtp_outputMethod);"BOOLEAN"==b.vtp_outputMethod&&d.push(b.vtp_onScreenRatio);c=d.join("&");var e=a[c],f=Number(Pp());if(e&&250>f-e.time)return e.value;e={time:f,value:null};var g=b.vtp_outputMethod,h=null;if("CSS"==b.vtp_selectorType){var l=ug(b.vtp_elementSelector);l&&0<
l.length&&(h=l[0])}else h=L.getElementById(b.vtp_elementId);if(h)switch(g){case "BOOLEAN":var n=(Number(b.vtp_onScreenRatio)||50)/100;e.value=am(h)>=n&&!Zl(h);break;case "PERCENT":e.value=0,Zl(h)||(e.value=Math.round(1E3*am(h))/10)}a[c]=e;return e.value})}();
